			...
			<div className="w-full md:w-1/2">
				<form className="bg-white rounded px-4 md:px-8 pt-6 pb-8 mb-4 shadow-md mx-2 md:mx-auto">
					<h2 className="text-extra-large font-bold my-4 text-center">
						Stake <span className="text-[#6837cf] mt-4">$SkalezInu</span>
					</h2>
					<div className="mb-4">
						<label
						...
						<span className="text-gray-500">{stakedBalance} $SkalezInu</span>
						<input
							className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mt-2"
							id="amount"
							type="number"
							placeholder="Enter amount to Unstake ($SkalezInu)"
